...
https://github.com/sergiooramas/elvis/blob/master/src/run_entity_linking.py
...
try:
    ...
    # NOTE form Frederic: for the purposes of the AMPL Lab we don't need the bit of the code where this is used
    # I added this try/except here so you don't need to install nltk dependency.
    pass
